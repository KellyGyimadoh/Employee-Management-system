...
<body class="fixed-navbar">
    <div class="page-wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="page-heading">
                <h1 class="page-title">EMPLOYEES SALARY</h1>
                <ol class="breadcrumb">
            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    <div class="ibox-head">
                        <div class="ibox-title">Employee Salaries</div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                            <ul class="salarypagination pagination">
    ...
    ?>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="../assets/js/salary.js"  type="module">
