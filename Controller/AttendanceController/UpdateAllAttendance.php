<?php
class UpdateAllAttendance extends Attendance{
...
private $checkinTime;
private $errors;
public function __construct($attendanceid,$userid,$currentdate,$status,$checkinTime){
    parent::__construct();
...
private function userCheckedInAlready(){
