...
include '../../Controller/DepartmentController/UpdateDepartment.php';
...
$status=isset($input['status']) ? filter_var($input['status'],FILTER_SANITIZE_NUMBER_INT): null;
...
if(!empty($csrfToken)&&hash_equals($_SESSION['csrf_token'],$csrfToken)){
    $newdepartment= new UpdateDepartment($id,$name,$head,$phone,$email,$status);
    $result= $newdepartment->updateNewDepartment();
    if($result['success']){
