...
include '../../Controller/SalaryController/CreateSalaryController.php';
...
try {
    ...
    if(!empty($csrfToken) && hash_equals($_SESSION['csrf_token'],$csrfToken)){
        $newsalary= new CreateSalaryController($userid,$baseSalary,$bonus,
        $deductions,$overtime,$totalSalary);
        $result=$newsalary->addNewSalary();
        if($result['success']){
