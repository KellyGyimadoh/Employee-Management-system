...
document.addEventListener("DOMContentLoaded", () => {
   ...
   (async ()=>{
    const userData= await fetchData('../../api/userview/process.viewstaff.php',currentPage,recordsPerPage,searchQuery)
    if(userData){
    ...
    recordsPerPageSelect.addEventListener("change", (e) => {
        ...
        (async ()=>{
            const userData= await fetchData('../../api/userview/process.viewstaff.php',currentPage,recordsPerPage,null)
            if(userData){
                 renderTable(userData.users)
                 renderPagination(userData.pagination.total_pages,userData.pagination.current_page);
            }
