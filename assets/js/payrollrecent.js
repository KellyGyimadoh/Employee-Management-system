...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const searchpayrollForm=document.getElementById("searchRecentPayroll");
   ...
   (async ()=>{
    const payrollData= await fetchData('../../api/payroll/process.fetchrecentpayroll.php',currentPage,recordsPerPageforPayroll,searchQuery,null,searchdate)
    if(payrollData){
...
recordsPerPagePayroll.addEventListener("change",(e)=>{
    ...
    currentPage=1
    (async ()=>{
        const payrollData= await fetchData('../../api/payroll/process.fetchrecentpayroll.php',
            currentPage,recordsPerPageforPayroll,searchQuery,null,searchdate)
        if(payrollData){
