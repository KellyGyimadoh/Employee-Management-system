...
document.addEventListener("DOMContentLoaded", () => {
   ...
   (async ()=>{
    const userData= await fetchData('../../api/userview/process.viewallusers.php',currentPage,recordsPerPage,searchQuery)
    if(userData){
    ...
    const renderTable =  (users) => {
        userTableBody.innerHTML = users
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm" href="../../api/userview/process.selectuser.php?userid=${user.id}">Edit</a>
    ...
    recordsPerPageSelect.addEventListener("change", (e) => {
        ...
        (async ()=>{
            const userData= await fetchData('../../api/userview/process.viewallusers.php',currentPage,recordsPerPage,null)
            if(userData){
                 renderTable(userData.users)
                 renderPagination(userData.pagination.total_pages,userData.pagination.current_page);
            }
